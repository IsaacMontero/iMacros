...
var imns = {
    ...
    FIO: {
        ...
        readTextFile: function(/* nsILocalFile */ file) {
            ...
            var branch = imns.prefsvc.getBranch("intl.charset.");
            var defCharset = branch.getCharPref("default"); // default 8bit charset
            var charsetList = ["UTF-8", defCharset, "UTF-16", "UTF-32"];
            for (var i = 0; i < charsetList.length; i++) {
                data = this._read(file, charsetList[i]);
